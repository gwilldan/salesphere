		...
		<div className="relative w-[50px] h-[50px] lg:w-[300px] lg:h-[300px] mx-auto flex items-center justify-center ">
			...
			<div className="absolute w-full h-full">
				<div className="absolute w-full h-full animate-spin-slow">
					<div className="absolute size-[75px] lg:w-[150px] lg:h-[150px] border border-dashed border-white rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
					...
					<div className="absolute w-full h-full animate-spin-slow">
						<div className="absolute size-[120px] lg:w-[200px] lg:h-[200px] border border-dashed border-white rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
					...
					<div className="absolute w-full h-full animate-spin-slow">
						<div className="absolute size-[175px] lg:w-[250px] lg:h-[250px] border border-dashed border-white rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
