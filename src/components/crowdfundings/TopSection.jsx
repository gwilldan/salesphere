	...
	return (
		<section className=" flex flex-col gap-3 lg:flex-row justify-between ">
			<div className="flex gap-3 bg-slate-600 rounded-lg">
				...
				/>
				<button  onClick={handleSearch} className="bg-blue-500 px-4 grid place-content-center text-lg rounded-lg hover:bg-blue-700 ease-linear duration-150 transition-colors ">
					<FaSearch />
				</button>
			</div>
			<Link
