...
const Nav = () => {
	...
	return (
		<nav className=" p-4 bg-slate-900 z-10  flex items-center justify-between border-b-[0.5px] border-slate-700 ease-linear duration-150 transition-all lg:h-[80px] relative">
			<div>
				<Link
					href="/"
